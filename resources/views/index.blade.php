...
<head>
    ...
    <link href=" {{asset('custom/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href=" {{asset('custom/css/price-range.css')}}" rel="stylesheet">
    <link href="{{asset('custom/css/animate.css')}}" rel="stylesheet">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="{{URL('images/home/girl1.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{URL('images/home/pricing.png')}}"  class="pricing" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<img src="{{URL('images/home/girl2.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{URL('images/home/pricing.png')}}"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{URL('images/home/girl3.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{URL('images/home/pricing.png')}}" class="pricing" alt="" />
								</div>
							</div>
								...
								<div class="product-image-wrapper">
									<div class="single-products">
											<div class="productinfo text-center">
												<img  width="" src='{{$item->picture_id}}' alt="" />
												<h2>${{$item->price}}</h2>
												<p>{{$item->item_name}}</p>
